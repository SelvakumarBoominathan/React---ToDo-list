...
//   useEffect(() => {
//     // Update task statuses based on the current filter option
//     const updatedStatuses = {};
//     tasks.forEach((task, index) => {
//       if (filterOption === 'All' || task.status === filterOption) {
//         updatedStatuses[index] = task.status || 'Not Completed';
//       }
//     });
...
//           <Card key={index} id='card-parent' className={task.status === 'Completed' ? 'completed-task' : 'not-completed-task'}>
                ...
                <span  >Status :</span> <span>
                  <select
                    style={{
                      ...
                      backgroundColor: taskStatuses[index] === 'Completed' ? 'lightgreen' : 'lightcoral'
                    }}
                    value={taskStatuses[index] || 'Not Completed'}
